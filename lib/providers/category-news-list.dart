...
class CategoryNewsData with ChangeNotifier {
  ...
  Future<void> fetchDataFromServer(String categoryName) async {
    final url = Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=in&category=${(categoryName).toLowerCase()}&apiKey=ec20db2447924cdda06848ada8178891');
